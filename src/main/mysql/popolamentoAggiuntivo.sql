...
('mario.rossi@email.com', 'hash_pwd_1', 'Mario', 'Rossi', '1985-05-12', 'Utente', '2023-01-15', 0, 0, 0),
('luca.bianchi@email.com', 'hash_pwd_2', 'Luca', 'Bianchi', '1990-08-23', 'Barman', '2023-02-10', 3, 12, 15),
('giulia.verdi@email.com', 'hash_pwd_3', 'Giulia', 'Verdi', '1992-11-05', 'Utente', '2023-02-14', 1, 5, 6),
('anna.neri@email.com', 'hash_pwd_4', 'Anna', 'Neri', '1988-03-30', 'Utente', '2023-03-01', 0, 2, 3),
('marco.gialli@email.com', 'hash_pwd_5', 'Marco', 'Gialli', '1995-07-19', 'Barman', '2023-03-10', 5, 20, 22),
('sofia.blu@email.com', 'hash_pwd_6', 'Sofia', 'Blu', '1998-01-22', 'Utente', '2023-04-05', 0, 1, 2),
('davide.rosa@email.com', 'hash_pwd_7', 'Davide', 'Rosa', '1982-09-14', 'Admin', '2022-11-20', 10, 50, 50),
('elena.viola@email.com', 'hash_pwd_8', 'Elena', 'Viola', '1993-06-08', 'Utente', '2023-05-12', 0, 3, 4),
('matteo.grigi@email.com', 'hash_pwd_9', 'Matteo', 'Grigi', '1991-12-01', 'Barman', '2023-05-20', 2, 8, 10),
('chiara.marroni@email.com', 'hash_pwd_10', 'Chiara', 'Marroni', '1997-04-15', 'Utente', '2023-06-01', 0, 0, 1),
('alessandro.ferri@email.com', 'hash_pwd_11', 'Alessandro', 'Ferri', '1989-10-10', 'Utente', '2023-06-15', 1, 4, 5),
('francesca.ricci@email.com', 'hash_pwd_12', 'Francesca', 'Ricci', '1994-02-28', 'Utente', '2023-07-01', 0, 2, 2),
('lorenzo.marini@email.com', 'hash_pwd_13', 'Lorenzo', 'Marini', '1987-08-05', 'Barman', '2023-07-10', 4, 15, 18),
('sara.galli@email.com', 'hash_pwd_14', 'Sara', 'Galli', '1996-11-11', 'Utente', '2023-08-01', 0, 1, 1),
('andrea.fontana@email.com', 'hash_pwd_15', 'Andrea', 'Fontana', '1990-05-25', 'Utente', '2023-08-15', 0, 3, 4),
('valentina.costa@email.com', 'hash_pwd_16', 'Valentina', 'Costa', '1993-09-30', 'Utente', '2023-09-01', 0, 0, 0),
('simone.giordano@email.com', 'hash_pwd_17', 'Simone', 'Giordano', '1986-01-17', 'Barman', '2023-09-10', 3, 10, 12),
('martina.rizzo@email.com', 'hash_pwd_18', 'Martina', 'Rizzo', '1999-03-22', 'Utente', '2023-10-01', 0, 2, 3),
('gabriele.lombardi@email.com', 'hash_pwd_19', 'Gabriele', 'Lombardi', '1991-07-07', 'Utente', '2023-10-15', 1, 5, 6),
('alice.barbieri@email.com', 'hash_pwd_20', 'Alice', 'Barbieri', '1995-12-12', 'Utente', '2023-11-01', 0, 1, 2),
('nicola.moretti@email.com', 'hash_pwd_21', 'Nicola', 'Moretti', '1984-04-04', 'Admin', '2022-12-01', 8, 40, 45),
('giorgia.conti@email.com', 'hash_pwd_22', 'Giorgia', 'Conti', '1992-08-18', 'Utente', '2023-11-15', 0, 3, 4),
('federico.de.luca@email.com', 'hash_pwd_23', 'Federico', 'De Luca', '1988-06-29', 'Barman', '2023-12-01', 2, 7, 9),
('camilla.mancini@email.com', 'hash_pwd_24', 'Camilla', 'Mancini', '1997-10-05', 'Utente', '2023-12-10', 0, 0, 1),
('riccardo.villa@email.com', 'hash_pwd_25', 'Riccardo', 'Villa', '1990-02-14', 'Utente', '2024-01-05', 0, 2, 3),
('beatrice.russo@email.com', 'hash_pwd_26', 'Beatrice', 'Russo', '1994-05-30', 'Utente', '2024-01-15', 0, 1, 1),
('tommaso.greco@email.com', 'hash_pwd_27', 'Tommaso', 'Greco', '1989-09-09', 'Barman', '2024-02-01', 3, 11, 14),
('elisa.bruno@email.com', 'hash_pwd_28', 'Elisa', 'Bruno', '1996-01-25', 'Utente', '2024-02-10', 0, 0, 0),
('daniele.gallo@email.com', 'hash_pwd_29', 'Daniele', 'Gallo', '1993-11-20', 'Utente', '2024-02-20', 0, 2, 2),
('silvia.leone@email.com', 'hash_pwd_30', 'Silvia', 'Leone', '1991-04-10', 'Utente', '2024-03-01', 0, 1, 2);
