...
In pratica, verranno memorizzati gli ingredienti necessari compresi di foto keywords per facilitarne l'individuazione e la categorizzazione.\\
Gli utenti si interfacceranno con il sistema tramite tre livelli di accesso:\\
...
Il sistema prevede la registrazione di \textbf{bar}. Ogni bar è associato ad un certo numero di \textit{utenti registrati}, da cui possono aggiungere una \textbf{creazione di gruppo}.
\\
