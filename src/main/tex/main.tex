...
\\
Riguardo l'operazione 7, la ridondanza non ha influito, poichè la ricerca avviene solo su campi non ridondanti.
\\
...
\begin{enumerate}
    ...
    \item \textbf{\textcolor{orange}{Admin} | ban di un utente dal sistema con cancellazione a cascata di recensioni e lista "preferiti", mantenimento delle ricette come anonime}\\
        Soluzione: Verrà inserito nel database un utente anonimo con userID = 1, a cui verranno associate le ricette appartenenti agli utenti eliminati.
        \\
